...
| **4 — Native terminal** | Real PTY terminal (vendored Apache-2.0 Termux `terminal-emulator`/`terminal-view`, JNI defects fixed) + BusyBox ash/coreutils, session-aware process teardown | **IN PROGRESS** — plan approved (APPROVE WITH CONDITIONS, all 11 conditions adopted: `docs/phase3-terminal-architecture.md` v2 + `docs/phase3-review-response.md`); implementation step 1 (vendoring both modules @ `3b66f8799635a4dba4a206563048ff0e6792c487` with our build scripts, upstream test suite green in CI) landed |
