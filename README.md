...
├── LICENSES/                      # per-component third-party license texts (terminal-emulator/-view Apache-2.0 landed; busybox GPL-2.0 at the BusyBox step)
