...
| `terminal-emulator/src/main/java/com/termux/terminal/JNI.java` | `System.loadLibrary("termux")` | `System.loadLibrary("rustdroidpty")` + `sendSignalToProcessGroup` native method | library rename (plan §4.2) + the RustDroid addition (plan §4.5) |
| `terminal-emulator/src/**` otherwise (14 Java main, 19 test files) | — | vendored as-is | none |
